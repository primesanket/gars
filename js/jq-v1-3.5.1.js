...
!(function (e, t) {
    ...
    (S.fn.ready = function (e) {
        ...
        (S.ready.then = F.then),
        "complete" === E.readyState || ("loading" !== E.readyState && !E.documentElement.doScroll) ? C.setTimeout(S.ready) : (E.addEventListener("DOMContentLoaded", B,{passive: true}), C.addEventListener("load", B));
                ...
                while (l--)
                    (d = g = (s = Te.exec(e[l]) || [])[1]),
                        ...
                        d &&
                            ...
                            (p = u[d]) || (((p = u[d] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(t, r, h, a)) || (t.addEventListener && t.addEventListener(d, a,{passive: true}))),
                ...
                return (
                    ...
                    r ||
                        ...
                        (u &&
                            ...
                            ((a = n[u]) && (n[u] = null),
                            (S.event.triggered = d),
                            e.isPropagationStopped() && f.addEventListener(d, wt,{passive: true}),
                            n[d](),
